...
[Download the starter files here](https://kmicinski.com/cis531-f25/assets/p3-starter.tar.gz)
...
- Remember, debugging is a key concept that you are practicing in this
  ...
  displayln at every match handler"), and (c) execute a test to
  falsify / validate their hypothesis, going back to step (a) with a
  refined hypothesis if necessary. Competence in debugging means
  becoming adept at iteratively formulating and refining hypotheses
  that will give you insight into what, exactly, is broken in your
  code: once the issue becomes possible to articulate, the fix is
  often trivial.
